  ...
  return (
    <SectionWrapper bg="black" padding="112px 24px">
      <div ref={ref} style={wrapper}>
        <h2 style={{ ...headline, ...reveal(0) }} className="agencies-cta-headline">
          The agencies that scale have a system.<br />
          Now you do too.
        </h2>

        <p style={{ ...subhead, ...reveal(1) }}>
          Request early access and see how ALYGNR works across your client portfolio.
        </p>
