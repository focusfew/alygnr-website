  ...
  return (
    <section className="px-6 md:px-12">
      <div className="mx-auto max-w-[1280px]">
        <div className="rounded-[24px] bg-white px-6 py-12 md:px-12 md:py-20">
          <div className="mx-auto flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex w-full flex-col justify-center gap-4 sm:w-auto sm:flex-row">
              <a
                href={APP_URL}
                className="inline-flex w-full items-center justify-center rounded-[8px] bg-[#13171D] px-6 py-4 text-[15px] text-white transition-colors duration-150 hover:bg-[#EC6427] sm:w-auto"
              >
                Try it
              </a>
              <Link
                href="/contact"
                className="inline-flex w-full items-center justify-center rounded-[8px] border-[1.5px] border-[#13171D] px-6 py-4 text-[15px] text-[#13171D] transition-colors duration-150 hover:border-[#EC6427] hover:text-[#EC6427] sm:w-auto"
              >
                See it first
              </Link>
            </div>
